...
import 'package:fypdashboard/views/dashboard/gymowner/add_gym_dialog.dart';
import 'package:fypdashboard/views/dashboard/gymowner/gym_edit_diaglog.dart';
import 'package:fypdashboard/views/dashboard/sidebar.dart';
import 'package:get/get.dart';

import '../../../controller/dashboard/gym_page_controller.dart';

class AdminGymPage extends StatelessWidget {
  final GymPageController controller = Get.put(GymPageController());
  final TextEditingController _searchController = TextEditingController();

  AdminGymPage({super.key});
                            ...
                            child: DataTable(
                              ...
                              rows: controller.filteredGymList
                                  .map(
                                    (gym) => DataRow(
                                      cells: [
                                        DataCell(Text(gym.gymId.toString())),
